<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form id="absensi-form" action="{{ route('simpan-absensi') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <span class="block text-lg font-semibold mb-2">Absen:</span>
                            <label class="mr-4 inline-flex items-center">
                                <input type="radio" name="absen" value="Masuk" class="hidden">
                                <span class="custom-radio mr-2"></span>
                                Masuk
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="absen" value="Pulang" class="hidden">
                                <span class="custom-radio mr-2"></span>
                                Pulang
                            </label>
                        </div>
    ...
    <style>
        ...
        .custom-radio::after {
            ...
            width: 12px;
            height: 12px;
            background: #4A5568; /* Warna abu-abu untuk keadaan normal */
            border-radius: 50%;
            position: absolute;
            top: 50%;
            left: 50%;
        ...
        input[type="radio"]:checked + .custom-radio {
            border-color: #4A5568; /* Warna abu-abu untuk keadaan terpilih */
        }
    </style>
